...
abstract class CronRunnable implements ServiceLocatorAwareInterface
{
    ...
    public function cronRun()
    {
        ...
        if (!$unlocked) {
            ...
            $this->_logService->log(LogService::LEVEL_INFO, $logRunCode, $logMessage, $logData, $logEntities);
